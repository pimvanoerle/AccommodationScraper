...
class ConnectorAirBnB(Connector):
    ...
    ameneties_map = {
        ...
        'Washer': Accommodation.Amenities.Washer,
        'Hangers': Accommodation.Amenities.Hangers
    }
    ...
    def parse(retrieved_data):
        ...
        # todo: these should all come from config!
        bedroomRegExp = "([0-9])+\sbedrooms?|Studio"
        bathroomRegExp = "([0-9])+\sbath?"
        name_selector = 'h1._1xu9tpch'
        type_selector = 'span._bt56vz6'
        amenities_selector = 'div._m7iebup'
        bedroom_class = "_y8ard79"
        bathroom_class = "_y8ard79"
        ...
        property_name = soup.select(name_selector)[0].text.strip()
        ...
        property_type = ConnectorAirBnB.property_type_map[soup.select(type_selector)[0].text.strip()]
        ...
        # todo: we should run regular tests against known scrape targets to make sure we catch change.
        ...
        bedroom_elements = soup.findAll('span', attrs={"class": bedroom_class}, text=regex)
        ...
        bathroom_elements = soup.findAll('span', attrs={"class": bathroom_class}, text=regex)
        ...
        amenities_raw = soup.findAll('span', text="Amenities")[0].parent.parent.parent.find_next_sibling('div').select(amenities_selector)
